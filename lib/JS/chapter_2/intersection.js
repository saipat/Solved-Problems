// Given 2 singly linkedLists, determine if the 2 lists intersect. Return the intersecting node. Note that the intersection is defined based on reference, not value.
...
// I => 7->1->6->1->2->3->4
// O => 5->9>2->3->4
// C => the intersection should based on the reference instead of the value
...
// move the long pointer to the difference in the length so that they both start at the same time.
