...
function productify(array){
    if(array.length <= 2) {
        throw new Error("There should atleast be 3 number in an array to find the product of 2 other numbers");
    }
...
console.log(`productify([2,4, 0]) => ${productify([2,4, 0])}`);
console.log(`productify([0,4, 0]) => ${productify([0,4, 0])}`);